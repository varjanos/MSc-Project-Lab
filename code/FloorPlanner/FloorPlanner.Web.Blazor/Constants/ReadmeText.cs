namespace FloorPlanner.Web.Blazor.Constants;

public static class ReadmeText
{
    public static readonly string Specification = @"## FloorPlanner
...
----";
    ...
    public static readonly string Wireframe = @"
### Wireframes
...
----";
    ...
    public static readonly string DBScheme = @"
### DB Scheme
